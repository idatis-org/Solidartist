                        ...
                        <Modal.Body>
                            {
                                artUploaded ?
                                    ...
                                    <Form encType='multipart/form-data'>
                                        ...
                                        <Form.Control type="file" name="file" id="upload-nft" onChange={(e) => { handleArtContent(e); handlePieceType(e); eraseError('upload-nft', 0) }} />
                                        ...
                                        <Form.Group controlId="formArtTitle">
                                            ...
                                            <Form.Control id="tituloSubirObra" type="text" placeholder="Titulo" value={formInfo.title} onChange={(e) => { handleTitle(e); eraseError('tituloSubirObra', 1) }} />
                                            <small class="texto-obligatorio-form" >Campo obligatorio</small>
                                        </Form.Group>

                                        <Form.Group controlId="formArtDescription">
                                            <Form.Label>Descripción</Form.Label>
                                            <Form.Control id="descSubirObra" type="text" placeholder="Descripcion" value={formInfo.description} onChange={handleDescription} />
                                            {/* <small class="texto-obligatorio-form" >Campo obligatorio</small> */}
                                        </Form.Group>

                                        <Form.Group controlId="formArtPrice">
                                            <Form.Label>Precio ( Separado por . )</Form.Label>
                                            <Form.Control id="precioSubirObra" type="number" placeholder="Precio" value={formInfo.sellPrice} onChange={(e) => { handleSellPrice(e); eraseError('precioSubirObra', 2) }} />
                                            <small class="texto-obligatorio-form" >Campo obligatorio</small>
                                        </Form.Group>
                                        <Form.Group controlId="formArtCategory">
                                            <Form.Label>Categoria</Form.Label>
                                            <Form.Select id="categoriaSubirObra" aria-label="Default select example" onChange={(e) => { handleCategory(e); eraseError('categoriaSubirObra', 3) }}>
                                        ...
                                        <Form.Group controlId="formArtCollections">
                                            ...
                                            <Form.Select id="coleccionSubirObra" aria-label="Default select example" onChange={(e) => { handleCollection(e); eraseError('coleccionSubirObra', 4) }}>
